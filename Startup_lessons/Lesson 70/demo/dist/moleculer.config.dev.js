...
module.exports = {
  ...
  metrics: {
    ...
    reporter: {
      ...
      options: {
        ...
        defaultLabels: function defaultLabels(registry) {
          return {
  ...
  created: function created(broker) {},
  // Called after broker started.
  started: function started(broker) {
    return regeneratorRuntime.async(function started$(_context) {
      while (1) {
  ...
  stopped: function stopped(broker) {
    return regeneratorRuntime.async(function stopped$(_context2) {
      while (1) {
